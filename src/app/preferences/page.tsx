                ...
                <div className="grid gap-3">
                    <div>
                        ...
                        <div className="flex items-center justify-between space-x-3">
                            <div className="">
                                <label className="text-[#b3b3b3] text-sm" htmlFor="">Choose language - Changes will be applied after restarting the app</label>
                            </div>
                            <div className="">
                                <span className="flex items-center justify-between">
                                    <select className="p-1 outline-none rounded" name="languages" id="language-select">
                    ...
                    <div>
                        ...
                        <div className="">
                            <div className="">
                                <label className="text-[#b3b3b3] text-sm" htmlFor="">Show the now-playing panel on click of play</label>
                            </div>
                            <div className="">
