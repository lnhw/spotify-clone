  ...
  return (
    <>
        ...
        <div id="" className="fixed h-14 w-full bottom-[70px] right-0 left-0">
          <div className="bg-[#2a3a1d] mx-2 p-2 rounded shadow">
            <div className="flex flex-col ">
              ...
              <progress
                className="h-[1px] rounded shadow"
                max={100}
                value={0}
              />
            </div>
      ...
      {isDesktop && (
        <div
          id="container"
          className="sticky bottom-0 left-0 right-0 w-full h-20 rounded shadow"
        >
                    ...
                    <div className="mb-2 flex items-center justify-center space-x-6">
                      ...
                      <div className="">
                        <button className="" type="button" onClick={() => {}}>
                          <Tooltip
                            content={state.isPlaying ? 'Tạm dừng' : 'Phát'}
                            position="top"
                          >
                            {state.isPlaying ? (
                              <IoIosPause
              ...
              <div className="h-full w-[30%] flex justify-end space-x-4">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    <input
                      className="h-1 w-[100px] cursor-pointer"
                      type="range"
                      name="volume"
                      min="0"
                      max="100"
