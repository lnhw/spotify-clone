                    ...
                    <ul className="px-3 py-2 bg-[#121212] rounded">
                        <li className="px-3 py-1">
                            <Link href={`/`} className="flex items-center justify-start">
                                ...
                                <span className="text-white">Trang chu</span>
                            </Link>
                        </li>
                        <li className="px-3 py-1">
                            <Link href={`/search`} className="flex items-center justify-start">
                                <IoIosSearch color="white" size={35} />
                                <span className="text-white">Tim kiem</span>
                            </Link>
                        </li>
                    </ul>
                </div >
                <div className="flex-1  bg-[#121212] rounded">
                    <div className="px-4 py-2 flex items-center justify-between">
                        <Tooltip content="Thu gọn thư viện" position="top">
                            <button type="button" className=" space-x-2 flex items-center justify-between">
                        ...
                        <div className="p-2 hover:bg-[#1d1c1c] hover:cursor-pointer rounded">
                            <div className="flex items-center justify-between space-x-1" >
                                ...
                                <div className="flex-grow flex items-center justify-between">
                                    <div className="">
                                        <p className="text-white text-sm font-normal">Thư mục mới</p>
                                        <p>
                                            <span className="">
                                            </span>
                                            <span className="text-white text-xs font-normal">danh sách phát</span>
                                        </p>
                                    </div>
                                    <div className="">

                                        <button type="button" onClick={handleClick}>
                                            {showPlaylist ? <IoMdArrowDropdown size={20} /> : <IoMdArrowDropright size={20} />}
                                        </button>
                                    </div>
                                </div>
                            </div>
