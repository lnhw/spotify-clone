...
export const PlayerActions = {
    ...
    setCurrentTime: (time: number) => createAction(PlayerActionTypes.SET_CURRENT_TIME, time),
    setDuration: (duration: number) => createAction(PlayerActionTypes.SET_DURATION, duration),
